...
- **(2025-04-29):** Out-of-Sample/Walk-Forward Validation section now included in the Markdown report if out-of-sample results are present. Section summarizes period, return, Sharpe, max drawdown, and a summary note, following Kalish Nadh's Markdown visualization philosophy. Fully TDD-compliant with new test in tests/test_report_generation.py. See report_generator.py for implementation.
